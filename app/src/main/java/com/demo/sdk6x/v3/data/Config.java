...
public final class Config {
     ...
     */
    private static final String DEF_SERVER       = "http://59.250.200.9:443/msp";
    public static final String DEF_USERNAME       = "admin";
    public static final String DEF_PASSWORD       = "hik12345+";
