...
public class ResourceListAdapter extends BaseAdapter {
	...
	private String getItemName(Object itemData) {
		if (itemData instanceof ControlUnitInfo) {
			...
			PrintLog.log(mContext,"ControlUnitInfo","数据是："+info.getName());
		...
		if (itemData instanceof RegionInfo) {
			...
			PrintLog.log(mContext,"RegionInfo","数据是："+info.getName());
		...
		if (itemData instanceof CameraInfo) {
			...
			PrintLog.log(mContext,"CameraInfo","数据是："+info.getName());
