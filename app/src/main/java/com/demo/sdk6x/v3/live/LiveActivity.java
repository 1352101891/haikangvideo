...
import com.demo.sdk6x.v3.data.Config;
import com.demo.sdk6x.v3.data.TempData;
import com.demo.sdk6x.v3.utils.DebugLog;
import com.demo.sdk6x.v3.utils.PrintLog;
import com.demo.sdk6x.v3.utils.ThreadUtil;
import com.demo.sdk6x.v3.utils.UIUtil;
import com.demo.sdk6x.v3.utils.UtilAudioPlay;
import com.demo.sdk6x.v3.utils.UtilFilePath;
...
public class LiveActivity extends Activity implements OnClickListener, OnCheckedChangeListener, Callback, LiveCallBack
{
    ...
    private void initData()
    {
        ...
        if (mVmsNetSDK == null)
        {
            ...
            PrintLog.log(this,"LiveActivity_initData","mVmsNetSDK is null");
            return;
        }
        
        String serAddr = Config.getIns().getServerAddr();
        String sessionid = mServInfo.getSessionID();
        PrintLog.log(LiveActivity.this,"initData","serAddr:"+serAddr+",sessionid:"+sessionid);
        ...
        if (null == mRtspHandle)
        {
            ...
            PrintLog.log(this,"LiveActivity_initialize","initialize:" + "RealPlay mRtspHandle is null!");
            return;
        }
    ...
    private void getCameraDetailInfo(final String serAddr, final String sessionid)
    {
        ThreadUtil.execute(new Runnable()
        {
            ...
            public void run()
            {
                ...
                PrintLog.log(LiveActivity.this,"LiveActivity_getCameraDetailInfo","result is :" + getCameraDetailInfoResult);
                mDeviceID = cameraInfoEx.getDeviceId();
                Log.i(Constants.LOG_TAG, "mDeviceID is :" + mDeviceID);
                deviceInfo = new DeviceInfo();
                PrintLog.log(LiveActivity.this,"LiveActivity_getCameraDetailInfo","mDeviceID is :" + mDeviceID);
                // 获取设备信息
                getDeviceInfoResult =
                    LiveActivity.this.mVmsNetSDK.getDeviceInfo(serAddr, sessionid, mDeviceID, deviceInfo);
                if (!getDeviceInfoResult || null == deviceInfo || deviceInfo.getLoginName() == null 
                		|| deviceInfo.getLoginPsw() == null || deviceInfo.getLoginName().equals("") || 
                ...
                PrintLog.log(LiveActivity.this,"LiveActivity_getCameraDetailInfo","ret is :" + getDeviceInfoResult + "----------------" + deviceInfo.getDeviceName() + "--------"
                        + "deviceLoginName is " + mName + "---" + "deviceLoginPassword is " + mPassword + "-----"
                        + "deviceID is " + mDeviceID);
            }
        });
    ...
    private void sendCtrlCmd(final int gestureID)
    {
        ThreadUtil.execute(new Runnable()
        {
            ...
            public void run()
            {
                ...
                PrintLog.log(LiveActivity.this,"sendCtrlCmd","ip:" + cameraInfoEx.getAcsIP() + ",port:" + cameraInfoEx.getAcsPort()
                        + ",isPTZControl:" + mUserCap.contains(PTZ_CONTROL));
                // 发送控制命令
                boolean ret =
                    LiveActivity.this.mVmsNetSDK.sendStartPTZCmd(cameraInfoEx.getAcsIP(),
                        ...
                        gestureID,
                        speed,
                        600,Integer.toString(cameraInfoEx.getCascadeFlag()));
                Log.i(Constants.LOG_TAG, "sendStartPTZCmd ret:" + ret);
                PrintLog.log(LiveActivity.this,"sendStartPTZCmd","sendStartPTZCmd ret:" + ret);
            }
        });
    }
            ...
            public void run()
            {
                ...
                boolean ret =
                    LiveActivity.this.mVmsNetSDK.sendStopPTZCmd(cameraInfoEx.getAcsIP(),
                        cameraInfoEx.getAcsPort(),
                        sessionID,
                        mCameraID,Integer.toString(cameraInfoEx.getCascadeFlag()));
    ...
    private void startBtnOnClick()
    {
        ...
        ThreadUtil.execute(new Runnable() {
            ...
            public void run()
            {
                ...
                PrintLog.log(LiveActivity.this,"startBtnOnClick","PlayUrl"+getPlayUrl(mStreamType)+",mName:"+mName+",mPassword"+mPassword);
    ...
    private String getPlayUrl(int streamType)
    {
        ...
        PrintLog.log(this,"getPlayUrl",  "generateLiveUrl MagStreamSerAddr:" + mServInfo.getMagServer().getMagStreamSerAddr());
        PrintLog.log(this,"getPlayUrl", "generateLiveUrl MagStreamSerPort:" + mServInfo.getMagServer().getMagStreamSerPort());
        PrintLog.log(this,"getPlayUrl", "generateLiveUrl cameraId:" + cameraInfoEx.getId());
        PrintLog.log(this,"getPlayUrl", "generateLiveUrl token:" + mToken);
        PrintLog.log(this,"getPlayUrl", "generateLiveUrl streamType:" + streamType);
        PrintLog.log(this,"getPlayUrl",  "generateLiveUrl appNetId:" + mServInfo.getAppNetId());
        PrintLog.log(this,"getPlayUrl", "generateLiveUrl deviceNetID:" + cameraInfoEx.getDeviceNetId());
        PrintLog.log(this,"getPlayUrl", "generateLiveUrl userAuthority:" + mServInfo.getUserAuthority());
        PrintLog.log(this,"getPlayUrl", "generateLiveUrl cascadeFlag:" + cameraInfoEx.getCascadeFlag());
        PrintLog.log(this,"getPlayUrl", "generateLiveUrl internet:" + mServInfo.isInternet());
        ...
        PrintLog.log(this,"getPlayUrl", "url1:" + mRealPlayURL.getUrl1());
        PrintLog.log(this,"getPlayUrl","url2:" + mRealPlayURL.getUrl2());
